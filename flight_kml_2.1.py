...
Edited 28/02/2019
Renaming of file using sensor number
Added comments etc
...
# define both sensors to be used in file naming
sensor1 = "VQ780S"
sensor2 = "VQ780H"
...
with open(csv2, 'r') as csv_file:
    ...
    # Check which sensor was used

    if new_start_value[0] == "Scanner 1":
        sensor = sensor1
    elif new_start_value[0] == "Channel 1":
        sensor = sensor2


    # Save KML file under flight name
    #save KML file with sensor number
    kml.save(flight_name + "_" + sensor + ".kml")
